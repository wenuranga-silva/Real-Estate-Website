            ...
            <Card>
                ...
                <form onSubmit={submitForm} className="mb-10 mt-5">
                    ...
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div className="flex flex-col w-full md:1/2 md:mr-5 mb-10">
                        ...
                        <div className="flex flex-col w-full md:1/2 mb-10">
                    ...
                    <div className="flex justify-around mt-5 mb-10">
                        ...
                        <PrimaryButton disabled={processing} type="submit" className="w-fit">{processing ? 'Processing ...' : 'Add Property'}</PrimaryButton>
